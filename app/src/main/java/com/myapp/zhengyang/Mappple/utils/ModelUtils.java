package com.myapp.zhengyang.Mappple.utils;
...
public class ModelUtils {
    ...
    private static String PRE_NAME = "models";

    public static void save(Context context, String key, Object object){
        SharedPreferences sp = context.getApplicationContext().getSharedPreferences(PRE_NAME, Context.MODE_PRIVATE);
    ...
    public static <T> T read(Context context, String key, TypeToken<T> typeToken){
        ...
        return toObject(jsonString, typeToken);
    }
